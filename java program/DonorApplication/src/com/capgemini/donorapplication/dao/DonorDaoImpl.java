...
public class DonorDaoImpl implements IDonorDAO 
{
	...
	public String addDonorDetails(DonorBean donor) throws Exception 
	{
	 ...
	 * @throws Exception 
	 ********************************************************************************************************/
	public DonorBean viewDonorDetails(String donorId) throws Exception {
	...
	public List<DonorBean> retriveAllDetails() throws Exception {
